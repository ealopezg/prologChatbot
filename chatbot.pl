...
pelicula("Los Extranos Caceria Nocturna","TERROR",5.6).
...
horarioP("Los Extranos: Caceria Nocturna",[["12:30","14:50","17:10"],["12:30","14:50","17:10"],["12:30","14:50","17:10"],["12:30","14:50","17:10"],["12:30","14:50","17:10"],["12:30","14:50","17:10"],["12:30","14:50","17:10"]]).
...
mensaje(formal,0,0,"Hola, en que lo puedo ayudar?").
mensaje(formal,0,0,"Buenos dias, en que lo puedo ayudar?").
mensaje(formal,0,0,"Hola, que agradable dia, en que lo puedo ayudar?").
mensaje(formal,0,1,"Buenas tardes, ¿Que necesita?").
mensaje(formal,0,1,"Buenas tardes, ¿Que puedo hacer por usted?").
mensaje(formal,0,2,"Buenas noches, ¿Que necesita?").
mensaje(formal,0,2,"Que linda que esta la luna....¿En que lo puedo ayudar?").
mensaje(formal,1,0,"Digame algun genero que le guste").
mensaje(formal,1,0,"Que genero le gusta?").
mensaje(formal,1,1,"Le recomiendo la pelicula: {} , tiene una puntuacion de {},Hasta Luego !!!").
mensaje(formal,1,1,"Tengo esta pelicula para usted: {} , tiene una puntuacion de {},Hasta Luego !!!").
mensaje(formal,2,0,"Para que dia?").
mensaje(formal,2,0,"Que dia?").
mensaje(formal,2,1,"Que pelicula desea ver?").
mensaje(formal,2,1,"Que pelicula quiere ver?").
mensaje(formal,2,2,"Para el dia {}, tenemos los siguientes horarios {},Hasta luego !!!").
mensaje(formal,2,2,"El dia {} tenemos los siguientes horarios {},Hasta luego !!!").
mensaje(formal,3,0,"Para que pelicula?").
mensaje(formal,3,0,"Que pelicula desea?").
mensaje(formal,3,1,"Que dia tiene pensado ir a verla?").
mensaje(formal,3,1,"Que dia?").
mensaje(formal,3,2,"Bueno, para el dia {} tenemos los siguientes horarios {},¿Que horario escoge?").
mensaje(formal,3,2,"Bueno, para el dia {} le tengo los siguientes horarios {},¿Que horario escoge?").
mensaje(formal,3,3,"Ok, su entrada esta reservada para el dia {} a las {},Hasta Luego !!!").
mensaje(formal,3,3,"Ok, su entrada esta reservada para el dia {} a las {},Adios...que tenga un lindo dia !!!").

mensaje(informal,0,0,"Hola, dime que quieres").
mensaje(informal,0,0,"Buenos dias,buenas tardes, que quieres").
mensaje(informal,0,0,"Hola, en que te puedo ayudar?").
mensaje(informal,0,1,"Buenas tardes, que quieres?").
mensaje(informal,0,1,"Buenas tardes, que $&$ queri' ? ").
mensaje(informal,0,2,"Esta brigida la luna... Que necesitai?").
mensaje(informal,0,2,"Buenas noches, En que te ayudo?").
mensaje(informal,1,0,"Digame algun genero que te guste").
mensaje(informal,1,0,"Que genero te gusta?").
mensaje(informal,1,1,"Te recomiendo la pelicula: {} , tiene una puntuacion de {},Me viro... !!!").
mensaje(informal,1,1,"Tengo esta pelicula para vo': {} , tiene una puntuacion de {},Bye !!!").
mensaje(informal,2,0,"Pa que dia?").
mensaje(informal,2,0,"Que dia queri'?").
mensaje(informal,2,1,"Que pelicula queri'?").
mensaje(informal,2,1,"Que pelicula queri' ver?").
mensaje(informal,2,2,"Pal {}, tenemos los siguientes horarios {},Hasta la vista... !!!").
mensaje(informal,2,2,"El {} te tengo los siguientes horarios {},Chao pescao !!!").
mensaje(informal,3,0,"que pelicula queri'").
mensaje(informal,3,0,"Que pelicula deseas baby?").
mensaje(informal,3,1,"Que dia tienes pensado ir a verla?").
mensaje(informal,3,1,"Que dia?").
mensaje(informal,3,2,"el dia {} estan los siguientes horarios {},cual quieres").
mensaje(informal,3,2,"Bueno, para el dia {} le tengo los siguientes horarios {},¿Que horario escoge?").
mensaje(informal,3,3,"Wena, tu entrada esta reservada para el dia {} a las {},Chao pescao !!!").
mensaje(informal,3,3,"Listo compa , tu entrada esta reservada para el dia {} a las {},Hasta la vista !!!").
